Feature: code-breaker submits guess
  ...
  Each position in the secret code can only be mattched once. For example, a guess of 1134 against a secret code of 1234 would get three plus singns: one for each of the exact matches in the first, third and fourth positions. The number match in the second position would be ignored.
